import{_ as p,r as i,o,c,a as n,b as s,d as a,f as l}from"./app-eb665f75.js";const r="/KBlogsPro/images/ailbaba/1.png",u="/KBlogsPro/images/ailbaba/2.png",d="/KBlogsPro/images/ailbaba/3.png",v="/KBlogsPro/images/ailbaba/4.png",b="/KBlogsPro/images/ailbaba/5.png",k="/KBlogsPro/images/ailbaba/6.png",m="/KBlogsPro/images/ailbaba/7.png",h="/KBlogsPro/images/ailbaba/8.png",g="/KBlogsPro/images/ailbaba/9.png",_={},f=l('<h1 id="alibaba-cloud-toolkit" tabindex="-1"><a class="header-anchor" href="#alibaba-cloud-toolkit" aria-hidden="true">#</a> Alibaba Cloud Toolkit</h1><p>阿里云工具包（Alibaba Cloud Toolkit）是一款由阿里云官方开发的插件，可以在Eclipse或IntelliJ IDEA中集成使用。它提供了可视化的控制台，使得开发者可以在集成开发环境（IDE）中管理和部署阿里云资源。<br> 插件实现自动化持续部署，可部署非阿里云服务器。<br> 本文使用的是idea操作，当然vscode也是可以的。</p><h2 id="一、配置服务器" tabindex="-1"><a class="header-anchor" href="#一、配置服务器" aria-hidden="true">#</a> 一、配置服务器</h2><p>字如其意<br><img src="'+r+'"><br><img src="'+u+'"><br> 可添加Tag/描述分辨多个服务器</p><h2 id="二、部署服务端项目" tabindex="-1"><a class="header-anchor" href="#二、部署服务端项目" aria-hidden="true">#</a> 二、部署服务端项目</h2><img src="'+d+'"><p>2.1配置<br> 配置restart.sh重启项目即可<br><img src="'+v+'"><br> 配置完成之后运行 maven自动打包<br><img src="'+b+'"><br> 查<strong>看部署成功，若无法访问，请查看是否开启端口号</strong><br><img src="'+k+`"></p><h2 id="三、shell脚本文件" tabindex="-1"><a class="header-anchor" href="#三、shell脚本文件" aria-hidden="true">#</a> 三、shell脚本文件</h2><h3 id="_3-1-方式一" tabindex="-1"><a class="header-anchor" href="#_3-1-方式一" aria-hidden="true">#</a> 3.1 方式一</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>start.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img src="`+m+'">',14),E={href:"http://xn--8pv109c.sh",target:"_blank",rel:"noopener noreferrer"},q=l('<h2 id="四、部署前端项目" tabindex="-1"><a class="header-anchor" href="#四、部署前端项目" aria-hidden="true">#</a> 四、部署前端项目</h2><p>部署完后端项目，就想着把前端也搞明白，于是就想了一下，发现还是比较简单的。<br> 1.首先把dist文件上传至nginx文件中<br> 2.删除之前部署的文件目录<br> 3.创建新的部署目录如：www/wwwroot/docs<br> 4.将dist文件内容copy到dosc中，删除dist文件<br><img src="'+h+`"></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#部署路径</span>
...
<span class="token builtin class-name">exit</span> <span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),w={href:"http://vue.sh",target:"_blank",rel:"noopener noreferrer"},I=n("br",null,null,-1),R=n("br",null,null,-1),P=n("br",null,null,-1),$=n("img",{src:g},null,-1);function S(x,D){const e=i("ExternalLinkIcon"),t=i("PDF");return o(),c("div",null,[f,n("p",null,[n("strong",null,[s("若部署时出现Permission denied，增加可执行权限，这里权限直接拉到最大 chmod 777 "),n("a",E,[s("脚本.sh"),a(e)])])]),q,n("p",null,[s("sh文件需要开启权限 "),n("strong",null,[s("chmod 777 "),n("a",w,[s("vue.sh"),a(e)])]),I,s(" 成功结果就不展示了。"),R,s(" 在配置nginx就可以了"),P,$]),a(t)])}const A=p(_,[["render",S],["__file","AlibabaToolkit.html.vue"]]);export{A as default};
