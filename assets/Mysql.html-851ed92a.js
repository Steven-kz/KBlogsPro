import{_ as r,r as l,o as d,c,a as n,b as s,d as e,f as a}from"./app-eb665f75.js";const o={},u=a('<h1 id="mysql进阶" tabindex="-1"><a class="header-anchor" href="#mysql进阶" aria-hidden="true">#</a> Mysql进阶</h1><h1 id="一、mysql进阶" tabindex="-1"><a class="header-anchor" href="#一、mysql进阶" aria-hidden="true">#</a> 一、Mysql进阶</h1><h3 id="_1-1mysql基础" tabindex="-1"><a class="header-anchor" href="#_1-1mysql基础" aria-hidden="true">#</a> 1.1Mysql基础</h3><p>DBMS：数据库管理系统<br> Mysql数据库的数据类型<br> 1.数字类型：int bigint tinyint double decimal(⻓度，⼩数点的位数)<br> 2.字符串类型：char varchar text<br> 3.⽇期类型：date datetime<br> Mysql约束条件：为字段添加约束条件<br> 1.主键约束<br> 2.外键约束<br> 3.⾮空约束<br> 4.唯⼀约束<br> 5.⾃增约束<br> 6.默认约束<br> SQL：结构化查询语⾔，操作数据库<br> SQL分类：<br> 1.DDL:数据定义 create drop alter<br> 2.DML:数据操作 insert update delete<br> 3.DQL:数据查询 select<br> 4.TPL(TCL):事务处理 commit rollback<br> 5.DCL:数据控制语⾔ grant<br> 6.CCL:指针控制语⾔ cursor</p><h4 id="_7大语句" tabindex="-1"><a class="header-anchor" href="#_7大语句" aria-hidden="true">#</a> 7⼤语句：</h4>',5),p=n("br",null,null,-1),v=n("br",null,null,-1),m=n("br",null,null,-1),b=n("br",null,null,-1),k=n("br",null,null,-1),g=n("br",null,null,-1),h=n("br",null,null,-1),y=n("br",null,null,-1),_=n("br",null,null,-1),q=n("br",null,null,-1),f=n("br",null,null,-1),S={href:"https://www.nowcoder.com/exam/oj?page=1&tab=SQL%E7%AF%87&topicId=268",target:"_blank",rel:"noopener noreferrer"},E=n("br",null,null,-1),x=n("br",null,null,-1),L=n("br",null,null,-1),w=n("br",null,null,-1),I=a(`<h3 id="_1-2-视图" tabindex="-1"><a class="header-anchor" href="#_1-2-视图" aria-hidden="true">#</a> 1.2 视图</h3><p>视图：对查询语句（临时表）的封装，简化操作，操作视图跟操作表⼀样<br> 创建视图：</p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>create view 视图名 as 查询语句; 
...
11.limit 
分⻚ 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),R=n("br",null,null,-1),D=n("strong",null,"笛卡尔积乘积指在数学上，两个",-1),Q={href:"https://so.csdn.net/so/search?q=%E9%9B%86%E5%90%88&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},C=n("strong",null,"集合",-1),M=n("strong",null,"X和Y的笛卡尔积 (Cartesian product)，又称直积，表示 X x Y，第一个对象是 X 的成员而第二个对象是 Y 的所有可能有序对的其中一个成员。",-1),A=a(`<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>eg1:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、mysql集群" tabindex="-1"><a class="header-anchor" href="#三、mysql集群" aria-hidden="true">#</a> 三、Mysql集群</h2><p>在⾼并发下、海量数据下，在所难免就要实现Mysql的集群搭建<br> Mysql本身可以实现主从复制，我们需要完成配置，就可以实现数据从主库⾃动到从库。</p><h3 id="_1-sharding-jdbc实现mysql集群" tabindex="-1"><a class="header-anchor" href="#_1-sharding-jdbc实现mysql集群" aria-hidden="true">#</a> 1. Sharding-JDBC实现Mysql集群</h3>`,15),B=n("strong",null,"当当⽹",-1),j=n("br",null,null,-1),O=n("br",null,null,-1),U=n("br",null,null,-1),P=n("br",null,null,-1),z=n("br",null,null,-1),F={href:"https://shardingsphere.apache.org/document/current/cn/quick-start/shardingsphere-jdbc-quick",target:"_blank",rel:"noopener noreferrer"},$=n("br",null,null,-1),W=n("br",null,null,-1),H=a(`<div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://steven-kz.github.io/BlogImgs/imgaes/20230311104645.png" alt="image.png" loading="lazy"><br> 这⾥遇到⼀个bug:<br> Sharding-jdbc使⽤Drud不能依赖druid-spring-boot-starter<br> 只能依赖:druid,否则就会遇到⼀个坑，报 Property &#39;sqlSessionFactory&#39; or &#39;sqlSessionTemplate&#39;<br> are requi<br> 后来查阅⽂档，官⽅⽂档，发现原来Sharding-jdbc4.0之后。就不能依赖这个包，会引起冲突。因为我<br> 们使⽤的Sharding-jdbc5.0以后的版本</p>`,4);function G(X,J){const i=l("ExternalLinkIcon"),t=l("PDF");return d(),c("div",null,[u,n("p",null,[s("1.创建表：CREATE table 表名 (字段 数据类型 约束条件,……)"),p,s(" 2.修改表：ALTER TABLE 表名 ADD 字段名 数据类型 约束条件"),v,s(" 3.删除表：DROP TABLE 表名"),m,s(" 4.新增数据：INSERT INTO 表名(字段名,……) values(值,……)"),b,s(" 5.修改数据：UPDATE 表名 set 字段=值,…… [where 条件]"),k,s(" 6.删除数据：DELETE FROM 表名 [where 条件]"),g,s(" 7.查询数据：SELECT 字段|* FROM 表名 [where 条件]"),h,s(" 查询条件：and or in like between and not is null order by limit group by having"),y,s(" 聚合函数：avg max min count sum"),_,s(" 复杂查询：⼦查询、笛卡尔积查询（⾃然查询）、内连接、左外连接、右外连接、全连接（Mysql不⽀"),q,s(" 持）"),f,s(" 需要刷题："),n("a",S,[s("https://www.nowcoder.com/exam/oj?page=1&tab=SQL篇&topicId=268"),e(i)]),E,s(" 数据删除：drop（把表都删除）、delete（删除表中数据）、truncate（删除表中的数据，并删除⾃增"),x,s(" 器）"),L,s(" 单位：分 bigint 好处：避免四舍五⼊ 缺陷：⻚⾯需要处理"),w,s(" 单位：元 decimal 好处：单位元，不需要额外处理 缺陷：四舍五⼊")]),I,n("p",null,[s("登录地址："),n("a",N,[s("http://localhost:8888/druid/sql.html"),e(i)])]),T,n("p",null,[s("笛卡尔积是什么？"),R,D,n("a",Q,[C,e(i)]),M]),A,n("p",null,[s("Sharding-JDBC 是"),B,s("开源的适⽤于微服务的分布式数据访问基础类库，完整的实现了分库分表，读"),j,s(" 写分离和分布式主键功能，并初步实现了柔性事务。从 2016 年开源⾄今，在经历了整体架构的数次精"),O,s(" 炼以及稳定性打磨后，如今它已积累了⾜够的底蕴。"),U,s(" ShardingSphere是⼀套开源的分布式数据库中间件解决⽅案组成的⽣态圈，它由Sharding-JDBC、"),P,s(" Sharding-Proxy 和 Sharding-Sidecar这3款相互独⽴的产品组成。"),z,n("a",F,[s("https://shardingsphere.apache.org/document/current/cn/quick-start/shardingsphere-jdbc-quick"),e(i)]),s(""),$,s(" start/"),W,s(" 1.maven配置")]),H,e(t)])}const Y=r(o,[["render",G],["__file","Mysql.html.vue"]]);export{Y as default};
